                            ...
                            <div class="profile-header">
                                ...
                                <div class="profile-details">
                                    <div class="user-identity">
                                        <h1>{$uname|stripslashes}{if $enable_levels eq "1" AND $price_mode eq "3"} <span style="font-size:12px">({$lang499} {$level|stripslashes}){/if}</apsn></h1>
                                    ...
                                    <span class="profile-meta">{if $toprated eq "1"}<img alt="{$lang468}" src="{$imageurl}/topratedscriptolution.png" /> {$lang468}<br />{/if}{$lang399} {$addtime|date_format} </span>
                              ...
                              <div class="seller">
                                <div class="holder order-btn">
                                  <div class="gig-head">
                                    ...
                                    <div class="orderNow">                                        
                                        <a class="order-now-g" style="padding-left:10px;padding-right:10px;padding-top:5px;padding-bottom:5px; background-color:#666; color:#FFF;" {if $smarty.session.USERID ne ""}href="{$baseurl}/{$posts[i].seo|stripslashes}/{$posts[i].PID|stripslashes}/{$title}"{else}href="{$baseurl}/login?r={insert name=get_redirect value=a assign=rurl PID=$posts[i].PID seo=$posts[i].seo gtitle=$title}{$rurl|stripslashes}"{/if}>{$lang107}</a>
                                    </div>
                                  </div>
                                  <br clear="all"/>
                                    ...
                                    <div class="gig-content-right">
                                      <div class="gig-image">
                                        ...
                                        <ul class="tags">
                                            ...
                                            <li><span><a href="{$baseurl}/tags/{$posts[i].seo|stripslashes}/{$tags[j]|stripslashes|replace:",":""}">{$tags[j]|stripslashes|replace:",":""}</a></span></li>
                                            {/section}
                                        </ul>
                                      </div>
                                    </div>

                ...
                <div id="main">
                  ...
                  {/if}
                    ...
                    <div class="wrapper">
                      ...
                      <div class="metadata">
                        <ul class="filters">                            
                            <li>{if $s eq "active"}<span>{$lang200} <u>{$o|@count}</u></span>{else}<a href="{$baseurl}/manage_orders?s=active&b={$b}&a={$a}"><span>{$lang200} <u>{$countd}</u></span></a>{/if}</li>
                          <li>{if $s eq "delivered"}<span>{$lang201} <u>{$o|@count}</u></span>{else}<a href="{$baseurl}/manage_orders?s=delivered&b={$b}&a={$a}"><span>{$lang201} <u>{$countc}</u></span></a>{/if}</li>
                          <li>{if $s eq "completed"}<span>{$lang202} <u>{$o|@count}</u></span>{else}<a href="{$baseurl}/manage_orders?s=completed&b={$b}&a={$a}"><span>{$lang202} <u>{$countb}</u></span></a>{/if}</li>
                          <li class="last">{if $s eq "cancelled"}<span>{$lang203} <u>{$o|@count}</u></span>{else}<a href="{$baseurl}/manage_orders?s=cancelled&b={$b}&a={$a}"><span>{$lang203} <u>{$counta}</u></span></a>{/if}</li>
                        </ul>
                      </div>
                      {if $o|@count eq "0"}
                      <div class="tabs">

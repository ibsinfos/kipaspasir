						  ...
						  <div class="order-flow messages"> 
                            ...
                            <div class="milestone okay reqbox" title="{$o.stime|date_format}">
                              ...
                              <div class="mutual-status underway">
                              	<h3>{$lang271}</h3>
                                <span>{$lang272}<a class="showInstructions" href="#">{$lang273}</a> {include file='track_ship2.tpl'}{include file='track_extras2.tpl'}</span><span class="instructions" style="display:none;"><p>{$o.ginst|stripslashes}</p></span></div>

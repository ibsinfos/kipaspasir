                          ...
                          <div class="c">
                            <div class="holder edit-status-&lt;%=gig.status%&gt;">
                              ...
                              <div class="frame">
                                ...
                                <strong style="color:orange;font-size:14px;margin:2px;">{$lang191}: {$lang502}</strong>
                                {/if}
                                <ul class="detail">
                                  <li>
                                ...
                                {if $posts[i].feat eq "0"} <span style="font-size:14px; color:#999">|</span> <a href="{$baseurl}/feature?id={$posts[i].PID}" style="color:orange;font-size:14px; text-decoration:none">{$lang465}</a>{/if}

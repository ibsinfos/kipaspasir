                    ...
                    <div class="wrapper">
                      ...
                      <div class="metadata">
                        <ul class="filters">
                          ...
                          <li>{if $s eq "active"}<span>{$lang190} <u>{$o|@count}</u></span>{else}<a href="{$baseurl}/orders?s=active&b={$b}&a={$a}"><span>{$lang190} <u>{$countd}</u></span></a>{/if}</li>
                          <li>{if $s eq "review"}<span>{$lang224} <u>{$o|@count}</u></span>{else}<a href="{$baseurl}/orders?s=review&b={$b}&a={$a}"><span>{$lang224} <u>{$countc}</u></span></a>{/if}</li>
                          <li>{if $s eq "completed"}<span>{$lang202} <u>{$o|@count}</u></span>{else}<a href="{$baseurl}/orders?s=completed&b={$b}&a={$a}"><span>{$lang202} <u>{$countb}</u></span></a>{/if}</li>
                          <li class="last">{if $s eq "cancelled"}<span>{$lang203} <u>{$o|@count}</u></span>{else}<a href="{$baseurl}/orders?s=cancelled&b={$b}&a={$a}"><span>{$lang203} <u>{$counta}</u></span></a>{/if}</li>
                        </ul>
                      </div>
                      {if $o|@count eq "0"}
                      <div class="tabs">

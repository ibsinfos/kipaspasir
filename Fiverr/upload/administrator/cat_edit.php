...
if($CATID > 0)
{
	if($_POST['submitform'] == "1")
	{
		...
		$sql = "update categories set name='".mysql_real_escape_string($name)."', seo='".mysql_real_escape_string($seo)."', details='".mysql_real_escape_string($details)."', mtitle='".mysql_real_escape_string($mtitle)."', mdesc='".mysql_real_escape_string($mdesc)."', mtags='".mysql_real_escape_string($mtags)."' where CATID='".mysql_real_escape_string($CATID)."'";
		$conn->execute($sql);

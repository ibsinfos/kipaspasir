...
{	
	...
	if($_POST['subform'] == "1")
	{
		...
		{	
			...
			$query="UPDATE members SET fullname='".mysql_real_escape_string($fname)."' $addmail ,country='".mysql_real_escape_string($country)."' $addme , description='".mysql_real_escape_string($details)."' WHERE USERID='".mysql_real_escape_string($SID)."' AND status='1'";

    ...
    width: 38%!important;">Image</th>
							...
							<tbody>
								<tr>
									...
									<td><a href="product_detail.html"><img alt="" src="<?=base_url(); ?>assets/themes/images/ladies/10.jpg"></a></td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="product_detail.html"><img alt="" src="<?=base_url(); ?>assets/themes/images/ladies/1.jpg"></a></td>
									<td>Aniza Coklat Sedap</td>
									<td><input type="text" placeholder="1" class="input-mini"></td>
									<td>3.0 Gram DPS </td>
									<td>0.2 Gram DPG</td>
								...
								<tr>
									<td><input type="checkbox" value="option1"></td>
									<td><a href="product_detail.html"><img alt="" src="<?=base_url(); ?>assets/themes/images/ladies/3.jpg"></a></td>
									<td>Aniza Coklat Sedap</td>
									<td><input type="text" placeholder="1" class="input-mini"></td>
									<td>3.0 Gram DPS </td>
									<td>0.2 Gram DPG</td>

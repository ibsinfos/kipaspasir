...
include 'connect.php';
$id = $_GET["ID"];
$sql = "SELECT * FROM mainmenu WHERE ID = '$id'";
$res = mysql_query($sql) or die (mysql_error());
$row = mysql_fetch_assoc($res);
?>

<script type="text/javascript" src="ckeditor/ckeditor.js"></script>
<script type='text/javascript' src='jquery-1.9.2.js'></script>
...
<td>Menu Title</td>
<td>:</td>
<td><input type="text" name="name" size="100" value="<?php echo $row["name"];?>">
<input type="hidden" name="odr" size="100" value="<?php echo $odr;?>">
</td>
</tr><tr>
<td>Menu Link(URL)</td>
<td>:</td>
<td><input type="text" name="url" size="100" value="<?php echo $row["url"];?>"></td>
</tr>
...
<input type='Submit' value='Submit' name='create'/></td>
</tr>
</tbody>
</table>

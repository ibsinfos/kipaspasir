...
//iPhone Version:document.write('<meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=yes;" />');
if((navigator.userAgent.match(/iPhone/i)) || (navigator.userAgent.match(/android/i))) 
{

		document.write('<link rel="stylesheet"  href="http://localhost/kipaspasir/alladein/wp-content/themes/dt-the7/mobile.css" type="text/css" media="all" />');
}
...
if((navigator.userAgent.match(/iPad/i))) 
{
		...
		document.write('<link rel="stylesheet"  href="http://localhost/kipaspasir/alladein/wp-content/themes/dt-the7/ipad.css" type="text/css" media="all" />');
}		

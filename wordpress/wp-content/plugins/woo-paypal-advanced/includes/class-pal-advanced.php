...
class Pal_Advanced {
    ...
    public function __construct() {
        ...
        add_filter("{$prefix}plugin_action_links_" . PAL_ADVANCED_PLUGIN_BASENAME, array($this, 'pal_advanced_plugin_action_links'), 10, 4);
    }
    ...
    public function premium_add_pal_advanced_gateways($methods) {
     ...
     public function pal_advanced_plugin_action_links($actions, $plugin_file, $plugin_data, $context) {
        $custom_actions = array(
            'configure' => sprintf('<a href="%s">%s</a>', admin_url('admin.php?page=wc-settings&tab=checkout&section=pal_advanced'), __('Configure', 'donation-button')),
            'docs' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://www.premiumdev.com/product/paypal-advanced-for-woocommerce/', __('Docs', 'donation-button')),
            'support' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://wordpress.org/support/plugin/woo-paypal-advanced', __('Support', 'donation-button')),
            'review' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://wordpress.org/support/view/plugin-reviews/woo-paypal-advanced', __('Write a Review', 'donation-button')),
        );

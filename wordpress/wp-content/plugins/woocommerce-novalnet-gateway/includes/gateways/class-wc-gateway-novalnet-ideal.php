 ...
 */
class WC_Gateway_Novalnet_Ideal extends NN_Payment_Gateways {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_api_response_novalnet_ideal', array( $this, 'check_novalnet_payment_response' ) );

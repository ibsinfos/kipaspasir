 ...
 */
class WC_Gateway_Novalnet_Instantbank extends NN_Payment_Gateways {
	 ...
	 * @var string
	 */
	private $paygate_url      = 'https://payport.novalnet.de/online_transfer_payport';
	...
	public function __construct() {
		...
		add_action( 'woocommerce_api_response_novalnet_instantbank', array( $this, 'check_novalnet_payment_response' ) );
